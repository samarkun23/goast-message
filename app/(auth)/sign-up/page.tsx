...
const signUpPage = () => {
  ...
  //For submit we want to use SubmitHandler we cannot give default data, through the submitHandler data is come
  //data come from the submitHandler 
